...
public abstract class AbstractMbaseSyntacticSequencer extends AbstractSyntacticSequencer {

	protected MbaseGrammarAccess grammarAccess;
	...
	protected void init(IGrammarAccess access) {
		grammarAccess = (MbaseGrammarAccess) access;

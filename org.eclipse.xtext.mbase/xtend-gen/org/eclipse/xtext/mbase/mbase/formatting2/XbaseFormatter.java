...
import org.eclipse.xtext.mbase.lib.Pure;
...
public class mbaseFormatter extends XtypeFormatter {
  ...
  protected void _format(final XConstructorCall expr, @Extension final IFormattableDocument format) {
    ...
    format.prepend(this.textRegionExtensions.regionFor(expr).feature(mbasePackage.Literals.XCONSTRUCTOR_CALL__CONSTRUCTOR), _function);
    ...
    for (final ObjectEntry<XMemberFeatureCall, ISemanticRegion> entry : calls) {
      {
        ...
        final ISemanticRegion feature = this.textRegionExtensions.regionFor(call).feature(mbasePackage.Literals.XABSTRACT_FEATURE_CALL__FEATURE);
        if ((feature != null)) {
  ...
  protected AbstractRule binaryOperationPrecedence(final EObject op) {
    final ISemanticRegion node = this.textRegionExtensions.regionFor(op).feature(mbasePackage.Literals.XABSTRACT_FEATURE_CALL__FEATURE);
    ...
    while (Objects.equal(this.binaryOperationPrecedence(top), precendece)) {
      {
        calls.prependWithLeadingSeparator(((XBinaryOperation) top), 
          this.textRegionExtensions.regionFor(top).feature(mbasePackage.Literals.XABSTRACT_FEATURE_CALL__FEATURE));
  ...
  protected void _format(final XTypeLiteral expr, @Extension final IFormattableDocument format) {
    ...
    format.append(format.prepend(this.textRegionExtensions.regionFor(expr).feature(mbasePackage.Literals.XTYPE_LITERAL__TYPE), _function_1), _function_2);
        ...
        for (final XCasePart c_2 : _cases_2) {
          {
            ...
            format.append(format.prepend(this.textRegionExtensions.regionFor(c_2).feature(mbasePackage.Literals.XCASE_PART__FALL_THROUGH), _function_14), _function_15);
          }
        }
  ...
  protected ISemanticRegion formatClosureParams(final XClosure expr, final ISemanticRegion open, @Extension final IFormattableDocument format, final Procedure1<? super IHiddenRegionFormatter> init) {
    ...
    if (_isExplicitSyntax) {
      final ISemanticRegion last = this.textRegionExtensions.regionFor(expr).feature(mbasePackage.Literals.XCLOSURE__EXPLICIT_SYNTAX);
  ...
  protected void _format(final XPostfixOperation expr, @Extension final IFormattableDocument doc) {
    ...
    doc.prepend(this.textRegionExtensions.regionFor(expr).feature(mbasePackage.Literals.XABSTRACT_FEATURE_CALL__FEATURE), _function);
  ...
  @Pure
  public mbaseGrammarAccess getGrammar() {
    return this.grammar;
  }
}

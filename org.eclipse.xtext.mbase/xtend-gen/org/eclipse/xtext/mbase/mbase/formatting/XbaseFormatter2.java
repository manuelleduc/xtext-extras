...
import org.eclipse.xtext.mbase.lib.Functions.Function1;
import org.eclipse.xtext.mbase.lib.IterableExtensions;
import org.eclipse.xtext.mbase.lib.ListExtensions;
import org.eclipse.xtext.mbase.lib.ObjectExtensions;
...
public class mbaseFormatter2 extends AbstractFormatter {
  ...
  protected void _format(final XVariableDeclaration expr, final FormattableDocument format) {
    ...
    Function1<? super FormattableDocument, ? extends Iterable<FormattingData>> _append_2 = this._formattingDataFactory.append(this._nodeModelAccess.nodeForFeature(expr, mbasePackage.Literals.XVARIABLE_DECLARATION__TYPE), _function_2);
    format.operator_add(_append_2);
    final Procedure1<FormattingDataInit> _function_3 = (FormattingDataInit it) -> {
      it.oneSpace();
    };
  ...
  protected XClosure builder(final List<XExpression> params) {
    ...
    if (_tripleNotEquals) {
      XClosure _xblockexpression = null;
      {
        ...
        if (((Objects.equal(grammarElement, this._mbaseGrammarAccess.getXMemberFeatureCallAccess().getMemberCallArgumentsXClosureParserRuleCall_1_1_4_0()) || 
          Objects.equal(grammarElement, this._mbaseGrammarAccess.getXFeatureCallAccess().getFeatureCallArgumentsXClosureParserRuleCall_4_0())) || 
          Objects.equal(grammarElement, this._mbaseGrammarAccess.getXConstructorCallAccess().getArgumentsXClosureParserRuleCall_5_0()))) {
  ...
  protected void _format(final XConstructorCall expr, final FormattableDocument format) {
    ...
    Function1<? super FormattableDocument, ? extends Iterable<FormattingData>> _prepend = this._formattingDataFactory.prepend(this._nodeModelAccess.nodeForFeature(expr, mbasePackage.Literals.XCONSTRUCTOR_CALL__CONSTRUCTOR), _function);
    format.operator_add(_prepend);
    ...
    for (final XMemberFeatureCall call : _reverse) {
      {
        ...
        final INode featureNode = this._nodeModelAccess.nodeForFeature(call, mbasePackage.Literals.XABSTRACT_FEATURE_CALL__FEATURE);
  ...
  protected AbstractRule binaryOperationPrecedence(final EObject op) {
    final INode node = this._nodeModelAccess.nodeForFeature(op, mbasePackage.Literals.XABSTRACT_FEATURE_CALL__FEATURE);
  ...
  protected void _format(final XBinaryOperation expr, final FormattableDocument format) {
    ...
    for (final XBinaryOperation call : _reverse) {
      {
        final INode op = this._nodeModelAccess.nodeForFeature(call, mbasePackage.Literals.XABSTRACT_FEATURE_CALL__FEATURE);
        final Procedure1<FormattingDataInit> _function = (FormattingDataInit it) -> {
          it.oneSpace();
        };
        Function1<? super FormattableDocument, ? extends Iterable<FormattingData>> _prepend = this._formattingDataFactory.prepend(op, _function);
  ...
  protected void _format(final XSynchronizedExpression expr, final FormattableDocument format) {
    ...
    Function1<? super FormattableDocument, ? extends Iterable<FormattingData>> _surround = this._formattingDataFactory.surround(this._nodeModelAccess.nodeForFeature(expr, mbasePackage.Literals.XSYNCHRONIZED_EXPRESSION__PARAM), _function_2);
    format.operator_add(_surround);
  ...
  protected void _format(final XIfExpression expr, final FormattableDocument format) {
    ...
    Function1<? super FormattableDocument, ? extends Iterable<FormattingData>> _surround = this._formattingDataFactory.surround(this._nodeModelAccess.nodeForFeature(expr, mbasePackage.Literals.XIF_EXPRESSION__IF), _function_2);
    format.operator_add(_surround);
  ...
  protected void _format(final XTypeLiteral expr, final FormattableDocument format) {
    final INode typeNode = this._nodeModelAccess.nodeForFeature(expr, mbasePackage.Literals.XTYPE_LITERAL__TYPE);
    final Procedure1<FormattingDataInit> _function = (FormattingDataInit it) -> {
      it.noSpace();
    };
        ...
        for (final XCasePart c_2 : _cases_2) {
          {
            ...
            if (_nodeForEObject_1 != null) {
              ...
              INode _nodeForFeature = this._nodeModelAccess.nodeForFeature(c_2, mbasePackage.Literals.XCASE_PART__FALL_THROUGH);
    ...
    for (final XCasePart c_3 : _cases_3) {
      {
        if (((c_3.getTypeGuard() != null) && (c_3.getCase() != null))) {
          final INode typenode = this._nodeModelAccess.nodeForFeature(c_3, mbasePackage.Literals.XCASE_PART__TYPE_GUARD);
          final INode casenode = this._nodeModelAccess.nodeForFeature(c_3, mbasePackage.Literals.XCASE_PART__CASE);
          final Procedure1<FormattingDataInit> _function_24 = (FormattingDataInit it) -> {
            it.oneSpace();
          };
          ...
          if (_tripleNotEquals_3) {
            final INode typenode_1 = this._nodeModelAccess.nodeForFeature(c_3, mbasePackage.Literals.XCASE_PART__TYPE_GUARD);
            ...
            if (_tripleNotEquals_4) {
              final INode casenode_1 = this._nodeModelAccess.nodeForFeature(c_3, mbasePackage.Literals.XCASE_PART__CASE);
  ...
  protected void formatClosureMultiLine(final XClosure expr, final INode open, final Collection<XExpression> children, final INode close, final FormattableDocument format) {
    ...
    final INode explicit = this._nodeModelAccess.nodeForFeature(expr, mbasePackage.Literals.XCLOSURE__EXPLICIT_SYNTAX);
    if ((explicit != null)) {
  ...
  protected void formatClosureWrapIfNeeded(final XClosure expr, final INode open, final Collection<XExpression> children, final INode close, final FormattableDocument format) {
    ...
    if (_isExplicitSyntax) {
      ...
      Function1<? super FormattableDocument, ? extends Iterable<FormattingData>> _append = this._formattingDataFactory.append(open, _function);
      format.operator_add(_append);
      last = this._nodeModelAccess.nodeForFeature(expr, mbasePackage.Literals.XCLOSURE__EXPLICIT_SYNTAX);
      boolean _isEmpty = expr.getDeclaredFormalParameters().isEmpty();
      boolean _not = (!_isEmpty);
      if (_not) {
        final Procedure1<FormattingDataInit> _function_1 = (FormattingDataInit it) -> {

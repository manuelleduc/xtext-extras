...
public class FormattableDocument {
    ...
    if ((data != null)) {
      FormattingData _xblockexpression = null;
      {
        ...
        if (_lessThan) {
          ...
          _builder.newLine();
          _builder.append("�text.key�[[[!!]]]�text.value�");
          _builder.newLine();
          _builder.append("---------------------------------------------------------------------------------");
          _builder.newLine();
        ...
        if (_greaterThan) {
          ...
          if (_not) {
            ...
            _builder_1.newLine();
            _builder_1.append("�text.key�[[[�oldText�]]]�text.value�");
            _builder_1.newLine();
            _builder_1.append("---------------------------------------------------------------------------------");
            _builder_1.newLine();
  ...
  protected void reportConflict(final FormattingData data1, final FormattingData data2) {
    ...
    _builder.append("---------------------------------------------------------------------------------");
    _builder.newLine();
    _builder.append("TextEdit1: �data1.toString.replaceAll(\"\\\\n\\\\s*\",\" \")�");
    _builder.newLine();
    _builder.append("TextEdit2: �data2.toString.replaceAll(\"\\\\n\\\\s*\",\" \")�");
    _builder.newLine();
      ...
      for (final TextReplacement edit : _renderToEdits) {
        {
          ...
          StringConcatenation _builder = new StringConcatenation();
          _builder.append("[�document.substring(edit.offset, edit.offset + edit.length)�|�edit.text�]");

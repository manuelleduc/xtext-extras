 ...
 */
public class mbaseUsageCrossReferencer extends UsageCrossReferencer {

	protected mbaseUsageCrossReferencer(EObject eObject) {
		super(eObject);
	}

	public static Collection<EStructuralFeature.Setting> find(EObject eObjectOfInterest, EObject eObject) {
		return new mbaseUsageCrossReferencer(eObject).findUsage(eObjectOfInterest);
	}

 ...
 */
public class mbaseInterpreter implements IExpressionInterpreter {
	...
	public mbaseInterpreter() {
	}

	public mbaseInterpreter(Provider<IEvaluationContext> contextProvider, JavaReflectAccess javaReflectAccess,
			ClassLoader loader) {

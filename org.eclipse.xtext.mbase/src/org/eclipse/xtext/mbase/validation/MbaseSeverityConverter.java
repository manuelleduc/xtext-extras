 ...
 */
public class MbaseSeverityConverter extends SeverityConverter {
	...
	public Severity stringToSeverity(final String severityAsString) {
		...
		if (severityAsString.startsWith(MbaseConfigurableIssueCodes.JDT_CORE_PLUGIN_ID)) {
	 ...
	 * 
	 * @param pair
	 *            holds first=delegationKey, second=defaultValue. delegationKey starts with {@link mbaseConfigurableIssueCodes#JDT_CORE_PLUGIN_ID}
	 ...
	 * @see mbaseSeverityConverter#encodeDefaultSeverity(String, String)
	 */

 ...
 * @author St�phane Galland - Add the "deprecation" warning. 
 */
@Singleton
public class MbaseConfigurableIssueCodes extends ConfigurableIssueCodesProvider {
...
//	}
	...
	protected PreferenceKey createDelegate(String id, String delegationKey, String defaultSeverity) {
		String encodedDelegation = MbaseSeverityConverter.encodeDefaultSeverity(delegationKey, defaultSeverity);

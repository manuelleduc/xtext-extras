...
/**
 * <p>The value converter service for mbase. It registers
 * the {@link QualifiedNameValueConverter} and a {@link KeywordBasedValueConverter}
 * for each operator.</p>
 * <p>Clients, who extend mbase should inherit from this value converter service.</p>
 * 
 * @author Sebastian Zarnekow - Initial contribution and API
 */
@Singleton
public class mbaseValueConverterService extends DefaultTerminalConverters {
	...
	@Inject
	private mbaseQualifiedNameValueConverter qualifiedNameValueConverter;

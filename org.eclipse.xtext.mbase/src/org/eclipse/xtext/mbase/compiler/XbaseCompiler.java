...
import org.eclipse.xtext.mbase.lib.Exceptions;
...
import org.eclipse.xtext.mbase.typesystem.override.BottomResolvedOperation;
import org.eclipse.xtext.mbase.typesystem.override.OverrideTester;
...
import org.eclipse.xtext.mbase.typesystem.util.DeclaratorTypeArgumentCollector;
import org.eclipse.xtext.mbase.typesystem.util.StandardTypeParameterSubstitutor;
import org.eclipse.xtext.mbase.util.XSwitchExpressionCompilationState;
 ...
 */
public class mbaseCompiler extends FeatureCallCompiler {
	...
	protected boolean canUseArrayInitializer(XListLiteral literal, ITreeAppendable appendable) {
		if (literal.eContainingFeature() == mbasePackage.Literals.XVARIABLE_DECLARATION__RIGHT
	...
	protected void constructorCallToJavaExpression(final XConstructorCall expr, ITreeAppendable b) {
		...
		ITreeAppendable typeAppendable = appendableWithNewKeyword.trace(expr, mbasePackage.Literals.XCONSTRUCTOR_CALL__CONSTRUCTOR, 0);

 ...
 * @since 2.7
 */
class MbaseRuntimeModule extends AbstractMbaseRuntimeModule {
	...
	@Deprecated override Class<? extends org.eclipse.xtext.formatting.IFormatter> bindIFormatter() {
		...
		// is fixed. 
		// without the binding, org.eclipse.xtext.mbase.tests.serializer.SerializerTest fails
		return org.eclipse.xtext.mbase.formatting.MbaseFormatter
	}
}

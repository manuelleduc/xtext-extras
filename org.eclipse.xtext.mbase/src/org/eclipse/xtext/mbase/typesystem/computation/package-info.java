...
/**
 * This package contains the primary hooks for the actual type computation in mbase
 * as well as their respective base implementations.
 * 
 * Sensible entry points to explore are the these interfaces.
 * <ol>
 *	<li>{@link org.eclipse.xtext.mbase.typesystem.computation.ITypeComputer ITypeComputer} -
 ...
 *    {@link org.eclipse.xtext.mbase.typesystem.computation.mbaseTypeComputer default implementation}.  
 *	</li>
 *  <li>{@link org.eclipse.xtext.mbase.typesystem.computation.ITypeComputationState ITypeComputationState} -
 ...
 *	</li>
 *  <li>{@link org.eclipse.xtext.mbase.typesystem.computation.ITypeExpectation ITypeExpectation} -
 *    One of the currently expected types. This can be evaluated in order to compute a type which
 *    depends on the current context, e.g. a {@link org.eclipse.xtext.mbase.XStringLiteral string}
 ...
 *	</li>
 *  <li>{@link org.eclipse.xtext.mbase.typesystem.computation.ITypeComputationResult ITypeComputationResult} -
 ...
 * <ol>
 *	<li>{@link org.eclipse.xtext.mbase.typesystem.computation.SynonymTypesProvider SynonymTypesProvider} -
 ...
 *    conversion.
 *	</li>
 *  <li>{@link org.eclipse.xtext.mbase.typesystem.computation.NumberLiterals NumberLiterals} -
 *    Type computation for {@link org.eclipse.xtext.mbase.XNumberLiteral}, e.g. which sort of concrete
 *    syntax may yield a {@link java.math.BigDecimal BigDecimal} or {@link java.math.BigInteger BigInteger}.
 *	</li>
 *  <li>{@link org.eclipse.xtext.mbase.typesystem.computation.ClosureTypeComputer ClosureTypeComputer} -
 *    The type computation of {@link org.eclipse.xtext.mbase.XClosure lambda expressions} is implemented in
 *    this utility.
 *	</li>
 * </ol>
 * 
 ...
 * <ol>
 *	<li>{@link org.eclipse.xtext.mbase.typesystem.computation.ILinkingCandidate Linking candidates} -
 ...
 *	</li>
 *  <li>{@link org.eclipse.xtext.mbase.typesystem.computation.ITypeAssigner ITypeAssigner} -

...
public class mbaseIdeCrossrefProposalProvider extends IdeCrossrefProposalProvider {
  ...
  public ContentAssistEntry createProposal(final IEObjectDescription candidate, final CrossReference crossRef, final ContentAssistContext context) {
    ...
    if (_hasIdRule) {
      final mbaseIdeCrossrefProposalProvider.ProposalBracketInfo bracketInfo = this.getProposalBracketInfo(candidate, context);
  ...
  protected mbaseIdeCrossrefProposalProvider.ProposalBracketInfo getProposalBracketInfo(final IEObjectDescription proposedDescription, final ContentAssistContext contentAssistContext) {
    final mbaseIdeCrossrefProposalProvider.ProposalBracketInfo info = new mbaseIdeCrossrefProposalProvider.ProposalBracketInfo();

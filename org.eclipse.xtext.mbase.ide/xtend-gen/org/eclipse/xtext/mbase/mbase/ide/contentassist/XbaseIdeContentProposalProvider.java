...
import org.eclipse.xtext.mbase.ide.contentassist.TypeFilters;
...
public class mbaseIdeContentProposalProvider extends IdeContentProposalProvider {
  ...
  protected void _createProposals(final RuleCall ruleCall, final ContentAssistContext context, final IIdeContentProposalAcceptor acceptor) {
    ...
    ParserRule _xExpressionRule = this._mbaseGrammarAccess.getXExpressionRule();
  ...
  protected void _createProposals(final Assignment assignment, final ContentAssistContext context, final IIdeContentProposalAcceptor acceptor) {
    ...
    boolean _matched = false;
    Assignment _featureAssignment_2 = this._mbaseGrammarAccess.getXFeatureCallAccess().getFeatureAssignment_2();
    if (Objects.equal(assignment, _featureAssignment_2)) {
      _matched=true;
      this.completeXFeatureCall(model, context, acceptor);
    }
    if (!_matched) {
      Assignment _featureAssignment_1_0_0_0_2 = this._mbaseGrammarAccess.getXMemberFeatureCallAccess().getFeatureAssignment_1_0_0_0_2();
      if (Objects.equal(assignment, _featureAssignment_1_0_0_0_2)) {
        _matched=true;
      }
      if (!_matched) {
        Assignment _featureAssignment_1_1_2 = this._mbaseGrammarAccess.getXMemberFeatureCallAccess().getFeatureAssignment_1_1_2();
    ...
    if (!_matched) {
      Assignment _expressionsAssignment_2_0 = this._mbaseGrammarAccess.getXBlockExpressionAccess().getExpressionsAssignment_2_0();
      if (Objects.equal(assignment, _expressionsAssignment_2_0)) {
        _matched=true;
      }
      if (!_matched) {
        Assignment _expressionsAssignment_1_0 = this._mbaseGrammarAccess.getXExpressionInClosureAccess().getExpressionsAssignment_1_0();
    ...
    if (!_matched) {
      Assignment _featureAssignment_0_1 = this._mbaseGrammarAccess.getXAssignmentAccess().getFeatureAssignment_0_1();
      if (Objects.equal(assignment, _featureAssignment_0_1)) {
        _matched=true;
      }
      if (!_matched) {
        Assignment _featureAssignment_1_1_0_0_1 = this._mbaseGrammarAccess.getXAssignmentAccess().getFeatureAssignment_1_1_0_0_1();
    ...
    if (!_matched) {
      Assignment _typeAssignment_0 = this._mbaseGrammarAccess.getJvmParameterizedTypeReferenceAccess().getTypeAssignment_0();
      if (Objects.equal(assignment, _typeAssignment_0)) {
        _matched=true;
      }
      if (!_matched) {
        Assignment _typeAssignment_1_4_1 = this._mbaseGrammarAccess.getJvmParameterizedTypeReferenceAccess().getTypeAssignment_1_4_1();
    ...
    if (!_matched) {
      Assignment _typeAssignment_1_0_1 = this._mbaseGrammarAccess.getXRelationalExpressionAccess().getTypeAssignment_1_0_1();
    ...
    if (!_matched) {
      Assignment _typeAssignment_3 = this._mbaseGrammarAccess.getXTypeLiteralAccess().getTypeAssignment_3();
      if (Objects.equal(assignment, _typeAssignment_3)) {
        _matched=true;
        this.completeJavaTypes(mbasePackage.Literals.XTYPE_LITERAL__TYPE, context, acceptor);
      }
    }
    if (!_matched) {
      Assignment _constructorAssignment_2 = this._mbaseGrammarAccess.getXConstructorCallAccess().getConstructorAssignment_2();
    ...
    if (!_matched) {
      Assignment _eachExpressionAssignment_3 = this._mbaseGrammarAccess.getXForLoopExpressionAccess().getEachExpressionAssignment_3();
      if (Objects.equal(assignment, _eachExpressionAssignment_3)) {
        _matched=true;
      }
      if (!_matched) {
        Assignment _defaultAssignment_5_2 = this._mbaseGrammarAccess.getXSwitchExpressionAccess().getDefaultAssignment_5_2();
        if (Objects.equal(assignment, _defaultAssignment_5_2)) {
          _matched=true;
        }
      }
      if (!_matched) {
        Assignment _caseAssignment_2_1 = this._mbaseGrammarAccess.getXCasePartAccess().getCaseAssignment_2_1();
        if (Objects.equal(assignment, _caseAssignment_2_1)) {
          _matched=true;
        }
      }
      if (!_matched) {
        Assignment _expressionAssignment_4 = this._mbaseGrammarAccess.getXCatchClauseAccess().getExpressionAssignment_4();
        if (Objects.equal(assignment, _expressionAssignment_4)) {
          _matched=true;
        }
      }
      if (!_matched) {
        Assignment _updateExpressionsAssignment_7_0 = this._mbaseGrammarAccess.getXBasicForLoopExpressionAccess().getUpdateExpressionsAssignment_7_0();
        if (Objects.equal(assignment, _updateExpressionsAssignment_7_0)) {
          _matched=true;
        }
      }
      if (!_matched) {
        Assignment _updateExpressionsAssignment_7_1_1 = this._mbaseGrammarAccess.getXBasicForLoopExpressionAccess().getUpdateExpressionsAssignment_7_1_1();
        if (Objects.equal(assignment, _updateExpressionsAssignment_7_1_1)) {
          _matched=true;
        }
      }
      if (!_matched) {
        Assignment _expressionAssignment_5 = this._mbaseGrammarAccess.getXBasicForLoopExpressionAccess().getExpressionAssignment_5();
        if (Objects.equal(assignment, _expressionAssignment_5)) {
          _matched=true;
        }
      }
      if (!_matched) {
        Assignment _eachExpressionAssignment_9 = this._mbaseGrammarAccess.getXBasicForLoopExpressionAccess().getEachExpressionAssignment_9();
        if (Objects.equal(assignment, _eachExpressionAssignment_9)) {
          _matched=true;
        }
      }
      if (!_matched) {
        Assignment _expressionAssignment_2 = this._mbaseGrammarAccess.getXClosureAccess().getExpressionAssignment_2();
        if (Objects.equal(assignment, _expressionAssignment_2)) {
          _matched=true;
        }
      }
      if (!_matched) {
        Assignment _expressionAssignment_1 = this._mbaseGrammarAccess.getXShortClosureAccess().getExpressionAssignment_1();
    ...
    if (!_matched) {
      Assignment _forExpressionAssignment_1 = this._mbaseGrammarAccess.getXForLoopExpressionAccess().getForExpressionAssignment_1();
      if (Objects.equal(assignment, _forExpressionAssignment_1)) {
        _matched=true;
      }
      if (!_matched) {
        Assignment _rightAssignment_3_1 = this._mbaseGrammarAccess.getXVariableDeclarationAccess().getRightAssignment_3_1();
    ...
    if (!_matched) {
      Assignment _thenAssignment_3_0_1 = this._mbaseGrammarAccess.getXCasePartAccess().getThenAssignment_3_0_1();
    ...
    if (!_matched) {
      Assignment _featureAssignment_1_0_0_1 = this._mbaseGrammarAccess.getXOrExpressionAccess().getFeatureAssignment_1_0_0_1();
      if (Objects.equal(assignment, _featureAssignment_1_0_0_1)) {
        _matched=true;
      }
      if (!_matched) {
        Assignment _featureAssignment_1_0_0_1_1 = this._mbaseGrammarAccess.getXAndExpressionAccess().getFeatureAssignment_1_0_0_1();
        if (Objects.equal(assignment, _featureAssignment_1_0_0_1_1)) {
          _matched=true;
        }
      }
      if (!_matched) {
        Assignment _featureAssignment_1_0_0_1_2 = this._mbaseGrammarAccess.getXEqualityExpressionAccess().getFeatureAssignment_1_0_0_1();
        if (Objects.equal(assignment, _featureAssignment_1_0_0_1_2)) {
          _matched=true;
        }
      }
      if (!_matched) {
        Assignment _featureAssignment_1_1_0_0_1_1 = this._mbaseGrammarAccess.getXRelationalExpressionAccess().getFeatureAssignment_1_1_0_0_1();
        if (Objects.equal(assignment, _featureAssignment_1_1_0_0_1_1)) {
          _matched=true;
        }
      }
      if (!_matched) {
        Assignment _featureAssignment_1_0_0_1_3 = this._mbaseGrammarAccess.getXOtherOperatorExpressionAccess().getFeatureAssignment_1_0_0_1();
        if (Objects.equal(assignment, _featureAssignment_1_0_0_1_3)) {
          _matched=true;
        }
      }
      if (!_matched) {
        Assignment _featureAssignment_1_0_0_1_4 = this._mbaseGrammarAccess.getXAdditiveExpressionAccess().getFeatureAssignment_1_0_0_1();
        if (Objects.equal(assignment, _featureAssignment_1_0_0_1_4)) {
          _matched=true;
        }
      }
      if (!_matched) {
        Assignment _featureAssignment_1_0_0_1_5 = this._mbaseGrammarAccess.getXMultiplicativeExpressionAccess().getFeatureAssignment_1_0_0_1();
        if (Objects.equal(assignment, _featureAssignment_1_0_0_1_5)) {
          _matched=true;
        }
      }
      if (!_matched) {
        Assignment _featureAssignment_1_0_1 = this._mbaseGrammarAccess.getXPostfixOperationAccess().getFeatureAssignment_1_0_1();
    ...
    if (!_matched) {
      Assignment _initExpressionsAssignment_3_0 = this._mbaseGrammarAccess.getXBasicForLoopExpressionAccess().getInitExpressionsAssignment_3_0();
      if (Objects.equal(assignment, _initExpressionsAssignment_3_0)) {
        _matched=true;
      }
      if (!_matched) {
        Assignment _initExpressionsAssignment_3_1_1 = this._mbaseGrammarAccess.getXBasicForLoopExpressionAccess().getInitExpressionsAssignment_3_1_1();
    ...
    if (!_matched) {
      Assignment _featureAssignment_0_1_1 = this._mbaseGrammarAccess.getXUnaryOperationAccess().getFeatureAssignment_0_1();
  ...
  protected boolean isInMemberFeatureCall(final EObject model, final int endOffset, final ContentAssistContext context) {
    if (((model instanceof XMemberFeatureCall) && (endOffset >= context.getOffset()))) {
      final List<INode> featureNodes = NodeModelUtils.findNodesForFeature(model, mbasePackage.Literals.XABSTRACT_FEATURE_CALL__FEATURE);
  ...
  protected void createLocalVariableAndImplicitProposals(final EObject model, final IExpressionScope.Anchor anchor, final ContentAssistContext context, final IIdeContentProposalAcceptor acceptor) {
    ...
    this.getCrossrefProposalProvider().lookupCrossReference(scope, this._mbaseGrammarAccess.getXFeatureCallAccess().getFeatureJvmIdentifiableElementCrossReference_2_0(), context, acceptor, this.featureDescriptionPredicate);
  }

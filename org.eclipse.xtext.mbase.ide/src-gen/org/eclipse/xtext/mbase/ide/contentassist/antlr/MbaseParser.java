 ...
 *******************************************************************************/
package org.eclipse.xtext.mbase.ide.contentassist.antlr;
...
import org.eclipse.xtext.mbase.ide.contentassist.antlr.internal.InternalMbaseParser;
import org.eclipse.xtext.mbase.services.MbaseGrammarAccess;

public class MbaseParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		@Inject
		public NameMappings(MbaseGrammarAccess grammarAccess) {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, MbaseGrammarAccess grammarAccess) {
	...
	@Override
	protected InternalMbaseParser createParser() {
		InternalMbaseParser result = new InternalMbaseParser(null);

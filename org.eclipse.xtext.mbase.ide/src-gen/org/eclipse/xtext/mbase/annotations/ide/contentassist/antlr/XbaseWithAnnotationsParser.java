 ...
 *******************************************************************************/
package org.eclipse.xtext.mbase.annotations.ide.contentassist.antlr;
...
import org.eclipse.xtext.mbase.annotations.ide.contentassist.antlr.internal.InternalmbaseWithAnnotationsParser;
import org.eclipse.xtext.mbase.annotations.services.mbaseWithAnnotationsGrammarAccess;

public class mbaseWithAnnotationsParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		@Inject
		public NameMappings(mbaseWithAnnotationsGrammarAccess grammarAccess) {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, mbaseWithAnnotationsGrammarAccess grammarAccess) {
	...
	@Override
	protected InternalmbaseWithAnnotationsParser createParser() {
		InternalmbaseWithAnnotationsParser result = new InternalmbaseWithAnnotationsParser(null);

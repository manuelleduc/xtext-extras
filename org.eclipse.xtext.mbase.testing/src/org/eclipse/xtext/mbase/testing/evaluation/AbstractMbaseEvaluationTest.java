 ...
 *******************************************************************************/
package org.eclipse.xtext.mbase.testing.evaluation;
...
import org.eclipse.xtext.mbase.testing.TemporaryFolder;
...
public abstract class AbstractMbaseEvaluationTest extends Assert {
	...
	@Test public void testBlock_01() throws Exception {
		assertEvaluatesTo(Boolean.TRUE, 
				...
				"  val test = newArrayList.map[1 -> org::eclipse::xtext::mbase::lib::Pair::of(fun1, fun2)]\n" + 
				"  val test2 = newArrayList.map[2 -> org::eclipse::xtext::mbase::lib::Pair::of(fun1, fun2)]\n" + 
...
//		assertEvaluatesWithException(UnsupportedOperationException.class, "newHashSet('').unmodifiableView().clear()");
	...
	protected void assertIntegerAssignOperations(Integer expectedResult, String mbaseCode) throws Exception {
		assertEvaluatesTo(expectedResult, mbaseCode);
	}
